  ...
  return (
    ...
    <div className={style.viewer_container}>
        ...
        <div className={style.viewer_left}>
            ...
            <div className={style.viewer_title}><span>Upgrade</span> to remove Lumen5 credit scene </div>
            <div className={style.viewer_btn}><button>Upgrade</button></div>
            </div>
            ...
            <div className={style.viewer_bottom}>
               ...
               <div>
                ...
                <div className={style.viewer_titlediv}><h1>Untitle Video</h1></div>
                <div className={style.viewer_content}>
                    <div className={style.viewer_contentleft}>
                       <div className={style.viewer_first}>P</div>
                       <div className={style.viewer_name}>Pooja Dhuri <br/>
                       Publish on 23 Aug</div>
                    </div>
                    <div className={style.viewer_contentright}>
                        <button className={style.viewer_Edit} onClick={()=>navigate("/videocreation")}>Edit Video</button>
                        <button className={style.viewer_download}
                        onClick={onDownload}
                        >Download</button>
               ...
               <div className={style.viewer_lastdiv}>
                ...
                <div className={style.viewer_btndiv}>
                    ...
                    <Button onClick={onOpen}>Transcript</Button>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <div className={style.viewer_right}>
             <div className={style.right_head}>Comments <span>scene 1</span></div>
             <div className={style.viewer_imgcontent}>
                <img src="https://storage.googleapis.com/lumen5-site-images/collab-comment.png" alt="" />
                <div>Be the first to leave a<br/>
                 comment on this scene</div>
             </div>
             <div className={style.viewer_btnlastdiv}><button>comment on this scene</button></div>
        </div>
    </div>
  )
}
